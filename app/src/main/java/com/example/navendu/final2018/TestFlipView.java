 ...
 * <p>
 * Add com.wajahatkarim3.TestFlipView.TestFlipView into your XML layouts with two direct children
 * views and you are done!
 * For more information, check http://github.com/wajahatkarim3/TestFlipView
 *
 * @author Wajahat Karim (http://wajahatkarim.com)
 * @version 2.0.4 18/12/2017
 */
public class TestFlipView extends FrameLayout {

    public static final String TAG = TestFlipView.class.getSimpleName();
    ...
    private int flipType = FlipType.VERTICAL;
    ...
    public TestFlipView(Context context) {
        super(context);
        this.context = context;
        init(context, null);
    }

    public TestFlipView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                flipType = attrArray.getInt(R.styleable.easy_flip_view_flipType, FlipType.HORIZONTAL);
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() > 2) {
            throw new IllegalStateException("TestFlipView can host only two direct children!");
        }
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (mFlipState == FlipState.FRONT_SIDE) {
                        ...
                        if (onFlipListener != null)
                            onFlipListener.onViewFlipCompleted(TestFlipView.this, FlipState.FRONT_SIDE);
                    } else {
                        mCardBackLayout.setVisibility(VISIBLE);
                        mCardFrontLayout.setVisibility(GONE);

                        if (onFlipListener != null)
                            onFlipListener.onViewFlipCompleted(TestFlipView.this, FlipState.BACK_SIDE);
                    }
                }
    ...
    {
        return flipType == FlipType.HORIZONTAL;
    }
    ...
    {
        return flipType == FlipType.VERTICAL;
    }
    ...
    */
    ...
    public interface OnFlipAnimationListener {
         ...
         *
         * @param TestFlipView The current TestFlipView instance
         * @param newCurrentSide After animation, the new side of the view. Either can be
         *                       FlipState.FRONT_SIDE or FlipState.BACK_SIDE
         */
        void onViewFlipCompleted(TestFlipView TestFlipView, FlipState newCurrentSide);
    }
}